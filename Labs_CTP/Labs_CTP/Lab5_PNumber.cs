...
namespace Labs_CTP
{
    public class PNumber
    {
        ...
        public PNumber(double a, int b, int c)
        {
            try
            {
        ...
        public PNumber(string a, string b, string c)
        {
        ...
        public PNumber Copy()
        {
            return (PNumber)this.MemberwiseClone();
        }
        ...
        public PNumber Substract(PNumber d)
        {
            PNumber tmp = d.Copy();
            if (d.b != this.b || d.c != this.c)
            {
        ...
        public PNumber Revers()
        {
            PNumber tmp = this.Copy();
            tmp.n = 1 / this.n;
            return tmp;
        }
        public PNumber Sqr()
